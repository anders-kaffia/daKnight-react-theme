	...
	<div class="row">
		<div class="background lazy" style="background-image:url('<?php echo $staticimage['url']; ?>'); ">
			...
			<p class="arrow animated infinite bounce">
				<img src="<?php echo get_template_directory_uri();?>/assets/media/img/Pil_Daknight.png ?>">
			</p>
		</div>
	</div>
...
<?php if(have_rows('section')) :
	while(have_rows('section')) : the_row(); ?>
		<div class="container-fluid section" style="background-color: <?php the_sub_field('color'); ?>">
			...
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2 push-up push-down">
					<?php if($color != '#ffffff') : ?>
						<h2 style="color: #ffffff;" class="push-up"><?php the_sub_field('title'); ?></h2>
					<?php else: ?>	
						<h2 class="push-up"><?php the_sub_field('title'); ?></h2>
					<?php endif;?>
					...
					<div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3"><?php the_sub_field('content'); ?></div>
				</div>
			</div>
		</div>
	<?php endwhile; 
...
<div class="container-fluid front-page">
	<div class="row contact-block">
		<div class="col-sm-6 col-sm-offset-3 contact-hover">
			...
			<h4 class="animated infinite"><?php the_field('contact_field_row_two'); ?></h4>
		</div>
	</div>
